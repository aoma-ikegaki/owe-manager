          ...
          <section>
            ...
            <div>
              {paidDebts.map((debt) => (
                <div
                  key={debt.id}
                  className="p-4 border rounded-lg shadow-sm flex justify-between items-center m-3"
                >
                  <div>
                  ...
                  <button
                    onClick={() => handleTogglePay(debt)}
                    className="text-xs bg-gray-700 text-white px-2 py-1 rounded hover:bg-gray-500"
                  >
                    戻す
                  </button>
                </div>
